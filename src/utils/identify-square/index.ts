...
/**
 *  function that identifies and returns the current square of a given Sudoku grid column and index
 * @param input Object with 9x9 Dudoku  Grid, row index and col index
 */
